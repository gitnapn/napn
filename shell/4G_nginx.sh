...
app_list=(ltePortal provPortal ltePad pubPortal portalService BusinessDispatchWeb channelService PrvncCrmExtrnlService PrvncCrmInnerService RuleManagerWeb RuleWeb smService SoWeb SRHttpServiceWeb casw RestCrmExtrnlService LTE-CSB)
...
function Usage(){
	...
	echo " 	sh $0 app  [all|ltePortal|provPortal|ltePad|pubPortal|portalService|BusinessDispatchWeb|channelService|PrvncCrmExtrnlService|PrvncCrmInnerService|RuleManagerWeb|RuleWeb|smService|SoWeb|SRHttpServiceWeb|casw|RestCrmExtrnlService|LTE-CSB] [A,a|B,b] # 切换app版本 "
	exit 2
}
